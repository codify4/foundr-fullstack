            ...
            <Dialog open={isSocialDialogOpen} onOpenChange={setIsSocialDialogOpen}>
              ...
              <DialogContent className='w-11/12 rounded-lg bg-white dark:bg-neutral-900 text-black dark:text-white'>
                ...
                <div className="space-y-4">
                  ...
                  <Button onClick={addSocial} className="bg-blue-600 hover:bg-blue-700 text-white">Add Social Media</Button>
                </div>
              </DialogContent>
            </Dialog>
            ...
            <Dialog open={isProjectDialogOpen} onOpenChange={setIsProjectDialogOpen}>
              ...
              <DialogContent className='w-11/12 rounded-lg bg-white dark:bg-neutral-900 text-black dark:text-white'>
                ...
                <div className="space-y-4">
                  ...
                  <Button onClick={addProject} className="bg-blue-600 hover:bg-blue-700 text-white">Add Project</Button>
                </div>
              </DialogContent>
            </Dialog>
            <ul className="mt-2 space-y-2">
