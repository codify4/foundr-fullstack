    ...
    <nav className="fixed top-0 left-0 z-50 bg-white text-primary w-full border-b">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="https://launch.drip.ma/waitlist/foundr-waitlist" target='_blank'>
            <Button variant="outline" className='hidden text-primary hover:text-primary md:flex md:items-center md:justify-center px-5 py-2 rounded-md'>Join Waitlist</Button>
          </Link>
